defmodule SianoWeb.Email do
  ...
  2. Remove the lib/siano/mailer.ex file
  ...
  def confirm_request(address, key) do
    ...
    |> text_body("Confirm your email here http://sianoapp.gigalixirapp.com/api/confirm?key=#{key}")
    |> Mailer.deliver_now()
  end
